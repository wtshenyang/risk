package com.iflytek.risk.generator;
...
/**
 * @program: law-risk->MybatisGenerator
 * @description: 代码生成器
 * @author: 黄智强
...
public class MybatisSqlGenerator {
    ...
    final static String MODEL_NAME = "risk";
    final static String TABLE_PRE = "t_fwfx_";
    // 数据库配置
    final static String DB_URL = "jdbc:mysql://127.0.0.1:3306/fwfx_db?useUnicode=true&useSSL=false&characterEncoding=utf8";
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        // 写于父类中的公共字段
        strategy.setSuperControllerClass("com.iflytek.risk.common.BaseController");
        strategy.setSuperEntityClass("com.iflytek.risk.common.BaseEntityBean");
