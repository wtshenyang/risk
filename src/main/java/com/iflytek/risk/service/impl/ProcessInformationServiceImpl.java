...
import com.iflytek.risk.mapper.ProcessInformationMapper;
 ...
 */
@Service
public class ProcessInformationServiceImpl extends ServiceImpl<ProcessInformationMapper, ProcessInformation> implements IProcessInformationService {
    ...
    public ResponseBean add(RequestBean requestBean) {
        return new ResponseBean(this.save(Hzq.convertValue(requestBean.getInfo(), ProcessInformation.class)));
    }
    ...
    public ResponseBean addBatch(RequestBean requestBean) {
        return new ResponseBean(this.saveBatch(Hzq.convertValue(requestBean.getInfos(), ProcessInformation.class)));
    }
    ...
    public ResponseBean updateAllField(RequestBean requestBean) {
        return new ResponseBean(this.updateById(Hzq.convertValue(requestBean.getInfo(), ProcessInformation.class)));
    }
    ...
    public ResponseBean updateAllFieldBatch(RequestBean requestBean) {
        return new ResponseBean(this.updateBatchById(Hzq.convertValue(requestBean.getInfos(), ProcessInformation.class)));
    }
