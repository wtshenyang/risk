...
import com.iflytek.risk.mapper.HearInformationMapper;
...
public class HearInformationServiceImpl extends ServiceImpl<HearInformationMapper, HearInformation> implements IHearInformationService {
    ...
    public ResponseBean add(RequestBean requestBean) {
        return new ResponseBean(this.save(Hzq.convertValue(requestBean.getInfo(), HearInformation.class)));
    }
    ...
    public ResponseBean addBatch(RequestBean requestBean) {
        return new ResponseBean(this.saveBatch(Hzq.convertValue(requestBean.getInfos(), HearInformation.class)));
    }
    ...
    public ResponseBean updateAllField(RequestBean requestBean) {
        return new ResponseBean(this.updateById(Hzq.convertValue(requestBean.getInfo(), HearInformation.class)));
    }
    ...
    public ResponseBean updateAllFieldBatch(RequestBean requestBean) {
        return new ResponseBean(this.updateBatchById(Hzq.convertValue(requestBean.getInfos(), HearInformation.class)));
    }
